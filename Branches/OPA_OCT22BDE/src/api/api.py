...
def get_data(symbol, interval, start_time: int=1546300800, end_time=None, limit: int=10000):#1546297200
...
kafka_host = os.environ.get('KAFKA_HOST', default="192.168.1.37")
kafka_producer = {}
...
def active_kakfa(pair):
    ...
    if os.environ.get('API_DEBUG')=="1":
            print("création du kakfa producer", pair)
    kline_object = Kline(pair)
    if os.environ.get('API_DEBUG')=="1":
            print("création du Kline", pair)
    ...
    def handle_socket_message(msg):
        ...
        if not initialized:
            ...
            start_time = stream_start_date - timedelta(seconds=1200)
